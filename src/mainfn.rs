...
use crate::diff::{
    changes::ChangeMap, dijkstra::mark_syntax, dijkstra::ExceededGraphLimit,
    sliders::fix_all_sliders, unchanged,
};
use crate::display;
...
use crate::options;
use crate::options::{DisplayMode, DisplayOptions, Mode, DEFAULT_TAB_WIDTH};
use crate::parse;
